    ...
    switch (operator) {
        ...
        case '÷': {
            /*
               ...
               содержит "" и мы нажимаем после деления сразу умножение или наоборот
               (например при комбинации (9 * 9 / *).
               Тогда деление/умножение происходило бы на 0, хотя операция не должна считать.
